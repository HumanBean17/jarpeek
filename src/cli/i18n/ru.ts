...
export const ru: Catalog = {
  ...
  "cli.description":
    "доступ к исходникам JVM для AI-агентов: собственный код проекта и его зависимости",
  ...
  "cmd.find-class":
    "поиск классов по FQN, суффиксу, простому имени или нечёткому совпадению — исходники проекта и зависимости вместе",
  "cmd.outline":
  ...
  "cmd.search-symbols":
    "поиск объявлений по имени члена в одном артефакте зависимостей (исходники проекта — через grep)",
  ...
  // -- help-block prose ----------------------------------------------------------
  "help.frugal":
    "экономный путь: find-class находит класс (он видит и исходники проекта, и зависимости), outline показывает его устройство, read-member даёт код конкретного члена — read-source нужен только для файла целиком.",
